                ...
                case 1:// Asignar Tarea Evento Recordatorio
                    ...
                    switch (opcionesSeleccion) {
                        ...
                        case 3:
                            ...
                            System.out.print("ingrese el horario de la Recordatorio (0-24) \n");
                    ...
                    switch (opcionesSeleccion) {
                        ...
                        case 2:
                            for (Evento evento : events) {
                                if (evento.nombre == nombre && evento.fecha == fecha
                        ...
                        case 3:
                            for (Recordatorio recordatorio : reminders) {
                                if (recordatorio.nombre == nombre && recordatorio.fecha == fecha
